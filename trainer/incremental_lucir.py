...
def incremental_train_and_eval(the_args, epochs, fusion_vars, ref_fusion_vars, b1_model, ref_model, b2_model, ref_b2_model, \
    ...
    K, lw_mr, balancedloader, fix_bn=False, weight_per_class=None, device=None, label_to_task_mapping=None):
    ...
    # Select K for this iteration
    K = min(K, num_cur_classes-num_old_classes)
    print("K: ", K)
