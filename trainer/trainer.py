        ...
        for iteration in range(start_iter, int(self.args.num_classes/self.args.nb_cl)):
            ...
            if iteration == start_iter:
                indices_train_10, X_valid_cumul, X_train_cumul, Y_valid_cumul, Y_train_cumul, \
                    ...
                    X_train, map_Y_train, map_Y_valid_cumul, X_valid_ori, Y_valid_ori, T_train, T_train_cumuls, T_valid, T_valid_cumuls, T_valid_cumul, T_train_cumul = \
                    ...
                    X_train_cumuls, Y_train_cumuls, X_valid_cumuls, Y_valid_cumuls, X_protoset_cumuls, Y_protoset_cumuls, T_train_cumuls, T_valid_cumuls, T_protoset_cumuls)
            else:
                indices_train_10, X_valid_cumul, X_train_cumul, Y_valid_cumul, Y_train_cumul, \
                    X_train_cumuls, Y_valid_cumuls, X_protoset_cumuls, Y_protoset_cumuls, X_valid_cumuls, Y_valid_cumuls, \
                    X_train, map_Y_train, map_Y_valid_cumul, X_protoset, Y_protoset, T_train, T_train_cumuls, T_valid, T_valid_cumuls, T_valid_cumul, T_train_cumul = \
                    self.init_current_phase_dataset(iteration, \
                    start_iter, last_iter, order, order_list, X_train_total, Y_train_total, X_valid_total, Y_valid_total, \
                    X_train_cumuls, Y_train_cumuls, X_valid_cumuls, Y_valid_cumuls, X_protoset_cumuls, Y_protoset_cumuls, T_train_cumuls, T_valid_cumuls, T_protoset_cumuls)                
            ...
            label_to_task_mapping = self.create_label_to_task_mapping(map_Y_train, T_train)
            print("Label to task mapping: ", label_to_task_mapping)
                ...
                if iteration > start_iter:
                    ...
                    if self.args.baseline == 'lucir':
                        b1_model, b2_model = incremental_train_and_eval_lucir(self.args, self.args.epochs, self.fusion_vars, \
                            ...
                            X_protoset_cumuls, Y_protoset_cumuls, order_list, cur_lambda, self.args.dist, self.args.K, self.args.lw_mr, balancedloader, label_to_task_mapping=label_to_task_mapping)    
                        ...
                        b1_model, b2_model = incremental_train_and_eval_icarl(self.args, self.args.epochs, self.fusion_vars, \
                            ...
                            self.args.icarl_T, self.args.icarl_beta, label_to_task_mapping=label_to_task_mapping)
                    else:
            ...
            X_protoset_cumuls, Y_protoset_cumuls, class_means, alpha_dr_herding, T_protoset_cumuls = self.set_exemplar_set(b1_model, b2_model, \
